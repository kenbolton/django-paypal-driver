...
class PayPalResponse(models.Model):
    ...
    def fill_from_response(self, response, action="Sale"):
        ...
        'AMT': '13.89', 'CORRELATIONID': 'f13dc648551be',
        ...
        'BUILD': '1105502', 'L_ERRORCODE0': '10410',
        'CORRELATIONID': 'c3e201df48a42'}
        ...
        'VERSION': '53.0', 'BUILD': '1077585', 'L_ERRORCODE0': '10007',
        ...
        {'ACK': 'Success', 'TIMESTAMP': '2011-11-10T17:04:31Z',
        'CURRENCYCODE': 'USD', 'VERSION': '53.0', 'BUILD': '2230381',
        'TRANSACTIONID': '2N691362SB560793C', 'AVSCODE': 'X',
        'AMT': '60.00', 'CORRELATIONID': 'e8c212627e9ab',
        'CVV2MATCH': 'M'  }
        """
